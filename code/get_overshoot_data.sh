# Purpose: Download ice sheet plot files and surface termperature data from 
# the TerraFIRMA overshoot simulations on MASS

# List of suite IDs to download data for: 
...
# Historical suites: cy623 da914 da916 da917
