...
Run as: "python new_diagnostics_GrIS.py [directory] [csv_file] [mask]"
@author: tom mitcham
"""
...
if masked:
    ...
    print("Running new_diagnostics_GrIS.py for directory: " + directory + " with mask: " + maskFile)

else:

    print("Running new_diagnostics_GrIS.py for directory: " + directory)
