...
with open("C:/Users/tm17544/OneDrive - University of Bristol/Projects/TerraFIRMA/processed_data/cs495_pyglint_SMB_AIS_GR_FL_masked.pkl", 'rb') as file:
...
cs495_GSAT.time = cs495_GSAT.time
cs495_GSAT = cs495_GSAT.iloc[:500] # only keep first 731 years to match others

cs495_SMB = pd.DataFrame(cs495_SMB)
cs495_SMB = cs495_SMB.iloc[:500]
...
ma_x = cs495_SMB["time"].values - 1950
ma_x = ma_x[int((box_size-1)/2):]
ma_x = ma_x[:-int((box_size-1)/2)]

plt.plot(ma_x, ma_y, label = "PI", lw=0.8, color='black')

ma_y = smooth((cs568_SMB["total_SMB"]), box_size)
ma_x = cs568_SMB["time"].values
ma_x = ma_x[int((box_size-1)/2):]
ma_x = ma_x[:-int((box_size-1)/2)]

plt.plot(ma_x, ma_y, label = "ZE-0 pyGlint", lw=0.8, color='grey')
...
plt.savefig(f"C:/Users/tm17544/OneDrive - University of Bristol/Projects/TerraFIRMA/figures/{icesheet}TotalSMBvsTime_updated_code_and_units.png", dpi = 600,  bbox_inches='tight')  
print("Plot saved successfully.")
...
ma_y = smooth((cs568_SMB["grounded_SMB"]), box_size)
ma_x = cs568_SMB["time"].values
ma_x = ma_x[int((box_size-1)/2):]
ma_x = ma_x[:-int((box_size-1)/2)]
...
plt.savefig(f"C:/Users/tm17544/OneDrive - University of Bristol/Projects/TerraFIRMA/figures/{icesheet}GroundedSMBvsTime_updated_code_and_units.png", dpi = 600,  bbox_inches='tight')  
print("Plot saved successfully.")
...
ma_y = smooth((cs568_SMB["floating_SMB"]), box_size)
ma_x = cs568_SMB["time"].values
ma_x = ma_x[int((box_size-1)/2):]
ma_x = ma_x[:-int((box_size-1)/2)]
...
plt.savefig(f"C:/Users/tm17544/OneDrive - University of Bristol/Projects/TerraFIRMA/figures/{icesheet}FloatingSMBvsTime_updated_code_and_units.png", dpi = 600,  bbox_inches='tight')  
print("Plot saved successfully.")