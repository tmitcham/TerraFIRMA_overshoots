...
for i in id:
    ...
    AIS_stats = pd.read_csv(f"/gws/nopw/j04/terrafirma/tm17544/TerraFIRMA_overshoots/processed_data/new_{i}_GrIS_diagnostics.csv")
...
ice_save_file = open('../processed_data/historical_icesheet_data_GrIS.pkl', 'wb') 
