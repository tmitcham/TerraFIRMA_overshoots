...
Run as: "python stats_AIS.py [directory] [mask]"
@author: matt
"""
...
if len(sys.argv) == 1:
    print('No directory specified. Select one by running the command "python stats_AIS.py [directory]"')
    sys.exit()
...
outfile = '/home/users/tm17544/gws_terrafirma/overshoots/processed_data/' + directory[55:60] + '_stats.csv'

if masked:
    outfile = '/home/users/tm17544/gws_terrafirma/overshoots/processed_data/' + directory[55:60] + '_' +  mask + '_stats.csv'
